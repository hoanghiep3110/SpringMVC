        ...
        <section class="bar">
            <div class="row portfolio-project">
                ...
                <div class="col-sm-12 my-5">
                    ...
                    <p style="font-size:larger"> <strong>XemayH2C</strong> là đơn vị tiên phong trong việc giải quyết bài toán cung-cầu xe máy cũ trên thị trường. XemayH2C muốn trở thành đơn vị mọi người nghĩ đến đầu tiên khi nghĩ đến xe máy cũ, xe thanh lý, xe đã qua sử dụng.</p>
                    <section>
                        <div class="row portfolio my-5">
                            ...
                            <div class="col-sm-6 my-5">
                                <div>
                                    ...
                                    <p style="font-size:larger"> Vì cơ sở vật chất tinh gọn, lượng khách hàng chủ yếu từ không gian mạng nên chúng tôi có thể từ đó cung cấp mức giá hời cho các chủ xe có nhu cầu nhượng lại người bạn đường của mình. XemayH2C là đơn vị chuyên nghiệp nên có các mức giá tiêu chuẩn cho các loại xe, đời xe. Tuyệt đối không có hình thức ép giá khách hàng.</p>
                                </div>
                            </div>
                            <div class="col-sm-6 my-5">
                                <div class="heading">
            ...
            <div class="col-md-12">
                ...
                <ul class="owl-carousel testimonials list-unstyled equal-height">
                    ...
                    <li class="item">
                        <div class="testimonial d-flex flex-wrap">
                            <div class="text">
                                <p>Cho ra đi em wave để lên đời con mô tô. Đăng trên các trang rao vặt mà cứ gặp nhiều người hỏi fix giá. Gọi điện thoại cho XemayH2C đến tận nhà xem xe chốt ngay và luôn, 5 sao cho cái nhanh gọn</p>
                            </div>
                            <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                                <div class="icon"><i class="fa fa-quote-left"></i></div>
                                <div class="testimonial-info d-flex">
