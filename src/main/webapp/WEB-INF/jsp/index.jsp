            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        <div class="icon-outlined"><i class="fas fa-biking"></i></div>
                        <h3 class="h4">Giao xe tận nhà</h3>
                        <p>Miễn phí nội thành thành phố Hồ Chí Minh </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        <div class="icon-outlined"><i class="fas fa-tools"></i></div>
                        <h3 class="h4">Bảo dưỡng</h3>
                        <p>Xe mua trong vòng 2 tháng đầu sử dụng được bảo hành miễn phí</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        <div class="icon-outlined"><i class="fas fa-signature"></i></div>
                        <h3 class="h4">Thủ tục nhanh chóng</h3>
                        <p> Sang tên nhanh chóng</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        <div class="icon-outlined"><i class="fa fa-users"></i></div>
                        <h3 class="h4">Tận tình</h3>
                        <p>Khách hàng là niềm tin của chúng tôi</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        <div class="icon-outlined"><i class="fas fa-chalkboard-teacher"></i></div>
                        <h3 class="h4">Chuyên nghiệp</h3>
                        <p>Phân tích, làm việc tập trung</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        <div class="icon-outlined"><i class="fas fa-chalkboard-teacher"></i></div>
                        <h3 class="h4">Ưu đãi</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="project owl-carousel">
                            <div class="item">
                                <div class="row portfolio text-center color-white">
                                        ...
                                        <div class="box-image">
                                            <div class="image"><img src="img/cub-125_2.png" alt="" class="img-fluid">
                                                <div class="overlay d-flex align-items-center justify-content-center">
                                                    <div class="content">
                                                        <div class="name">
                                                            <h3><a href="portfolio-detail.html" class="color-white">Thông tin chi tiết</a></h3>
                                                        </div>
                                                        <div class="text">
                                                            <p class="d-sm-none">Pellentesque habitant morbi tristique senectus et netus etmalesuada</p>
                                                            <p class="buttons"><a href="portfolio-detail.html"
                                                                                  class="btn btn-template-outlined-white">View</a><a href="#"
                                                                                  class="btn btn-template-outlined-white">Mua ngay</a></p>
                                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="box-image">
                                            <div class="image"><img src="img/grande-ltd-2020_6.png" alt="" class="img-fluid">
                                                <div class="overlay d-flex align-items-center justify-content-center">
                                                    <div class="content">
                                                        <div class="name">
                                                            <h3><a href="portfolio-detail.html" class="color-white">Thông tin chi tiết</a></h3>
                            ...
                            <div class="row portfolio text-center color-white">
                                ...
                                <div class="col-md-4">
                                    <div class="box-image">
                                        <div class="image"><img src="img/winner-x-v10-phien-ban-camo.png" alt="" class="img-fluid">
                                            <div class="overlay d-flex align-items-center justify-content-center">
                                                <div class="content">
                                                    <div class="name">
                                                        <h3><a href="portfolio-detail.html" class="color-white">Thông tin chi tiết</a></h3>
                                ...
                                <div class="col-md-4">
                                    <div class="box-image">
                                        <div class="image"><img src="img/winner-x-v10-phien-ban-den-mo_1.png" alt="" class="img-fluid">
                                            <div class="overlay d-flex align-items-center justify-content-center">
                                                <div class="content">
                                                    <div class="name">
                                                        <h3><a href="portfolio-detail.html" class="color-white">Thông tin chi tiết</a></h3>
                            ...
                            <div class="row portfolio text-center color-white">
                                ...
                                <div class="col-md-4">
                                    <div class="box-image">
                                        <div class="image"><img src="img/monkey_1.png" alt="" class="img-fluid">
                                            <div class="overlay d-flex align-items-center justify-content-center">
                                                <div class="content">
                                                    <div class="name">
                                                        <h3><a href="portfolio-detail.html" class="color-white">Thông tin chi tiết</a></h3>
                ...
                <div class="see-more text-center">
                    <p></p><a href="portfolio-4.html" class="btn btn-template-outlined">Xem thêm</a>
                </div>
            </div>
        </div>
    </div>
</section>
<section style="background: url(img/bannervespa.png) center top no-repeat; background-size: cover;"
    ...
    <div class="container">
        ...
        <h1 class="text-uppercase">bạn cần tìm một chiếc xe mới cho mình?</h1>
        <p class="lead">Chúng tôi là đơn vị hàng đầu cung cấp nhiều dòng xe dành cho mọi đối tượng sử dụng</p>
        <p class="text-center"><a href="index2.html" class="btn btn-template-outlined-white btn-lg">Liên hệ ngay với
                chúng tôi </a></p>
    </div>
</section>
...
<div class="container">
    <header class="text-center">
        <h1 class="small-heading">Our success stories</h1>
    </header>
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="img/tạpchixeHusqvarna.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="#"
                                                                                                     class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                        </div>
                        <div class="text">
                            <h4><a href="#">mô tô Husqvarna sẽ có mặt tại Việt Nam vào tháng 8 </a></h4>
                            <p class="author-category">By <a href="#">Đạt Phạm</a> in <a href="#">Tạp chí xe</a></p>
                            <p class="intro">Husqvarna - thương hiệu xe nước Áo có nguồn gốc Thụy Điển sẽ sớm có mặt tại Việt Nam
                                trong năm nay. </p><a href="#" class="btn btn-template-outlined">Đọc thêm</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="img/tạpchixeyamaha.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="#"
                                                                                                     class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                        </div>
                        <div class="text">
                            <h4><a href="#">Yamaha R1 2016: đẹp, mạnh, động cơ khác với số đông</a></h4>
                            <p class="author-category">By <a href="#">Vũ Chí</a> in <a href="#">Tạp chí xe</a></p>
                            <p class="intro">FYamaha R1 là một chiếc superbike được nhiều anh em yêu thích từ khi mới ra mắt cho
                                tới thời điểm hiện tại.</p><a href="#" class="btn btn-template-outlined">Đọc thêm</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="img/tapchixeDibaoCreer.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="#"
                                                                                                     class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                        </div>
                        <div class="text">
                            <h4><a href="#">Trên tay Dibao Creer 50cc: xe dành cho học sinh, giá 24 triệu </a></h4>
                            <p class="author-category">By <a href="#">Hiệp Phan</a> in <a href="#">Tạp chí xe</a></p>
                            <p class="intro">Dibao Creer là mẫu xe 50 phân khối với thiết kế hướng đến các bạn vẫn chưa có bằng
                                lái</p><a href="#" class="btn btn-template-outlined">Đọc thêm</a>
                        </div>
                    </div>
                </div>
            </div>
