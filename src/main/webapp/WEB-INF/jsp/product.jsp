...
<div id="heading-breadcrumbs">
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                <h1 class="h2">C?A HÀNG</h1>
            </div>
            <div class="col-md-5">
                <ul class="breadcrumb d-flex justify-content-end">
                    <li class="breadcrumb-item"><a href="<c:url value="/"/>">TRANG CH?</a></li>
                    <li class="breadcrumb-item active">C?A HÀNG</li>
                </ul>
    ...
    <div class="container">
        <section class="bar">
            <div class="row">
                <div class="col-md-12">
                    <div class="heading">
                        <h2><a href="<c:url value="/product"/>">S?N PH?M</a></h2>
                    </div>
                </div>
                                ...
                                <div class="box-image card">
                                    <div class="image">
                                        <a href="<c:url value="/detail/${item.idProduct}"/>">
                                            ...
                                            <div style="text-align:center;">Giá : ${item.price}d</div>
        ...
        <div class="row showcase text-center">
            <div class="col-md-3 col-sm-6">
                <div class="item">
                    ...
                    <h4><span class="h1 counter">3</span><br> Kinh nghi?m</h4>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="item">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="item">
                    ...
                    <h4><span class="h1 counter">10232</span><br>Ðon hàng</h4>
                </div>
            </div>
        </div>
    </div>
