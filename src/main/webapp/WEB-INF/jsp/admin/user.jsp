    ...
    <tbody>
        <c:forEach items="${listUser}" var="item" >
            <tr>
                ...
                <td>
                    ...
                    <a data-target="#deleteModal${item.idUser}" data-toggle="modal" title="Xóa" class="btn btn-sm btn-danger" >
        ...
        <div class="modal fade" id="deleteModal${item.idUser}" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">XÓA NGƯỜI DÙNG</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
